        ...
        <div class="card-box">
            ...
            <div class="am-g">
                <div class="am-u-sm-12">
                    <form class="am-form" action="<?php echo U('Admin/update');?>" method="post" id="form">
                        <table class="am-table am-table-striped am-table-hover table-main">
                            <thead>
                            <tr>
                                <td>管理员的名称</td>
                                <td><input type="text" name="login_name"  value="<?php echo ($loginDate["login_name"]); ?>"/></td>
                            </tr>
                            <tr>
                                <td>输旧的密码</td>
                            ...
                            <input type="hidden" name="login_id" value="<?php echo ($loginDate["login_id"]); ?>"/>
                            </thead>
                        </table>
                    </form>
                </div>
