                ...
                <div class="am-u-sm-12 am-u-md-6">
                    <div class="am-btn-toolbar">
                        <div class="am-btn-group am-btn-group-xs">
                            <button type="button" class="am-btn am-btn-default"><span class="am-icon-plus"></span><a href="<?php echo U('Login/add');?>">管理员添加</a> </button>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="am-table am-table-striped am-table-hover table-main">
                            ...
                            <tbody>
                                 <?php if(is_array($loginName)): foreach($loginName as $key=>$v): ?><tr align="center">
                                    ...
                                    <td>
                                        <div class="am-btn-group am-btn-group-xs">
                                                <button class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span><a href="<?php echo U('Login/up');?>?id=<?php echo ($v["login_id"]); ?>"> 编辑</a></button>
                                                <button class="am-btn am-btn-default am-btn-xs am-hide-sm-only"><span class="am-icon-copy"></span> 复制</button>
                                                <button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-trash-o"></span> <a href="<?php echo U('Login/del');?>?id=<?php echo ($v["login_id"]); ?>">删除</a></button>
                                            </div>
                                    </td>
